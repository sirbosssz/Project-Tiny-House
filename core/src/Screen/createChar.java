...
public class createChar extends AbstractScreen{
	...
	private Table backTable, cre_char_Back_Ta, char_ta, selDel_Ta, cre_char_Back_Ta_Act, press_back_but_ta, start_game_table;
	...
	private int stateKeep = 0, stateCheck = 0, createState = 0, menuState = 0;
	...
	public void show() {
		...
		tex1 = new Texture(Gdx.files.internal("picture/Background/Create_Char_Back.png"));
		tex2 = new Texture(Gdx.files.internal("picture/Background/Char_Creback.png"));
		tex3 = new Texture(Gdx.files.internal("picture/Background/Half Circle.png"));
		tex4 = new Texture(Gdx.files.internal("picture/CharSprite/Cat Walk0001.png"));
		tex5 = new Texture(Gdx.files.internal("picture/Background/selback.png"));
		tex6 = new Texture(Gdx.files.internal("picture/Background/Outline.png"));
	...
	public void render(float delta){
		...
		if(backbutton.isPressed()){
			...
			stage.addAction(Actions.fadeOut(0.1f));
		...
		sel_But.addListener(new ClickListener(){
			...
			public void clicked (InputEvent event, float x, float y) {
				if(stateCheck == 0 && createState != 0){
					stateKeep = 1;
					select.up = selDelSkin.getDrawable("all purpose exit button");
				}
				else if(stateCheck == 1 && stateKeep == 1){
					stateKeep = 0;
					select.up = selDelSkin.getDrawable("all purpose accept button");
				}
			}
